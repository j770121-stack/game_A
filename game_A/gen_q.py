...
labels_title = ['一', '二', '三', '四', '五', '六', '七', '八', '九', '十',
                '十一', '十二', '十三', '十四', '十五', '十六', '十七', '十八', '十九', '二十',
                '二十一', '二十二', '二十三十', '二十四', '二十五', '二十六', '二十七', '二十八', '二十九', '三十',
                '三十一', '三十二', '三十三', '三十四', '三十五', '三十六', '三十七', '三十八', '三十九', '四十']

themes = ['天氣', '探險', '生氣', '晚餐', '哭泣', '過河', '下雨', '失眠', '魔法', '寶箱',
...
for i in range(len(raw_q_data)):
    q = raw_q_data[i]
    t = themes[i]
    n = labels_title[i]
    if i == 22:
        n = '二十三'
    out_lines.append(f'[題目{n}：{t}] Q: {q[0]}')
    
    a_tag = f'({attr_map[q[2]]}/{attr_map[q[3]]})'
    b_tag = f'({attr_map[q[5]]}/{attr_map[q[6]]})'
    c_tag = f'({attr_map[q[8]]}/{attr_map[q[9]]})'
    out_lines.append(f'A: {q[1]} {a_tag} | B: {q[4]} {b_tag} | C: {q[7]} {c_tag}\n')

with open('c:/Users/jay20/Desktop/game_A/soul_questions_list.txt', 'w', encoding='utf-8') as f:
    f.write('\n'.join(out_lines))
