...
let appJs = fs.readFileSync('c:/Users/jay20/Desktop/game_A/App.js', 'utf8');

// 去除 import
appJs = appJs.replace(/import .*?from 'react';\r?\n/, '');
appJs = appJs.replace(/import '\.\/styles\.css';\r?\n/, '');

const indexHtml = fs.readFileSync('c:/Users/jay20/Desktop/game_A/index.html', 'utf8');
...
fs.writeFileSync('c:/Users/jay20/Desktop/game_A/index.html', prefix + newBabel + suffix);
